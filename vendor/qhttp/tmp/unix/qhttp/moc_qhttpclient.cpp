...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_qhttp__client__QHttpClient_t, stringdata) + ofs \
...
void qhttp::client::QHttpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHttpClient::httpConnected)) {
                *result = 0;
            }
        }
        {
            typedef void (QHttpClient::*_t)(QHttpResponse * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHttpClient::newResponse)) {
                *result = 1;
            }
        }
        {
            typedef void (QHttpClient::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHttpClient::disconnected)) {
                *result = 2;
            }
        }
        {
            typedef void (QHttpClient::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHttpClient::connectingTimeOut)) {
                *result = 3;
            }
        }
    }
...
const QMetaObject qhttp::client::QHttpClient::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_qhttp__client__QHttpClient.data,
      qt_meta_data_qhttp__client__QHttpClient,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_qhttp__client__QHttpClient.stringdata))
        return static_cast<void*>(const_cast< QHttpClient*>(this));
